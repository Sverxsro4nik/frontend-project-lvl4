  ...
  return (
      <Modal.Dialog className='modal-dialog-centered'>
        ...
        <Modal.Body>
          ...
          <form>
            <FormGroup>
              <input type="button" className="btn btn-secondary" value={t('modals.cancelButton')} onClick={closeHandler}/>
              <input type="button" className="btn btn-danger" value={t('modals.removeButton')} onClick={deleteChannel}/>
            </FormGroup>
          </form>
        </Modal.Body>
      </Modal.Dialog>
